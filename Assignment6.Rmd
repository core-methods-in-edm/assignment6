...
```
The accuracy for the first model is 21.9% and for second model is 53.6%, therefore model 2 has a lower error rate.
...
```
The accuracy of the first model is 26.08%. The accuracy of the second model is 26.04%. Two models are having almost the same accuracy, but considering the parsimony of the model, second model is better because it uses fewer variables to predict the outcome.
