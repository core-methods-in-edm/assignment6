...
```
As you can see from the tables, the 2nd predition is correct for 5363/10000 (53.63%) while the first one is correct for 2186/10000 (21.86%). Therefore, the pruned tree has a lower error rate.