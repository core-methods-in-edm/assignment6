...
### explanation
Second model, second tree has greater true positive and overall accuracy. It shows that the pruned model is more generaliable in the data. 
...
```{r}
D1 <- read.csv("student_course.csv", header=TRUE)
...
The second model is better because it has smaller relative error.
