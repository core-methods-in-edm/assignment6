...
```{r}
c.tree2 <- prune(c.tree1,data=M1,cp=0.00392157) 
...
# My prune tree make a better prediction since with larger accuracy in predication. The sum of no-yes and yes-no on prune tree (2255) is lower than the results in the original tree (3344), reveals a larger biasness in predictions for original tree.
```