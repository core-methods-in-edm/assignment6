...
#I can see assignment and grade variables in the tree. 
...
#Calculate the error rate for tree1: (24+7790)/10000 = 0.7814
#for tree 2: (1184+3453)/10000 = 0.4637
#Therefore, tree2 has lower error rate and better prediction for "wild sample"
```
