...
rm(student.record)
#I couldn't run this code since it kept showing the following error: Error: cannot allocate vector of size 44.0 Gb
#Ctree1 <- rpart(GPAO ~ ANONID + SUBJECT + CATALOG_NBR + GRD_PTS_PER_UNIT + DIV, method = "class", data = D1)
#printcp(Ctree1)
#rpart.plot(Ctree1)
#I was planning to build the second model by predicting GPAO from SUBJECT and GRD-PTS_PER_UNIT variables.
#Ctree2 <- rpart(GPAO ~ SUBJECT + GRD_PTC_PER_UNIT, method = "class", data = D1)
#printcp(Ctree2)
#rpart.plot(Ctree2)
#SInce I had problems with memory limits, I couldn't visualise and analyse the models. 
