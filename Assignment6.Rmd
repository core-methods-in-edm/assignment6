...
```{r}
c.tree2 <- prune(c.tree1, cp =0.0582)#Set cp to the level at which you want the tree to end

#Visualize this tree and compare it to the one you generated earlier

printcp(c.tree2)

# we have 2 nodes based on cp=0.0582
...
```
The error from Tree 1 is almost 78%
The error from Tree 2 is about 35%
Therefore, Tree 2 has a smaller error