...
ct1 <- table(M2$certified, M2$predict1)
ct1

ct2 <- table(M2$certified, M2$predict2)
ct2

accuracy1 = sum(ct1[1,1],ct1[2,2])/nrow(M2)
accuracy1

accuracy2 = sum(ct2[1,1],ct2[2,2])/nrow(M2)
accuracy2

#Therefore, the second tree has a lower error rate since it has the higher accurancy.
```
