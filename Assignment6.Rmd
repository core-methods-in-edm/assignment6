...
c.tree1 <- rpart(certified~grade + assignment + forum.posts, method = "class", data=M1, control = rpart.control(minsplit = 5))
...
```{r}
c.tree2 <- prune(c.tree1, cp = 0.02)#Set cp to the level at which you want the tree to end
