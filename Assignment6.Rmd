...
c.tree1<- rpart(certified ~ grade + forum.posts + assignment, method="class", data = M1)
c.tree1_1 <- rpart(certified ~ scale_grade + scale_forum + scale_asg, method="class", data = M1)
c.tree1_2 <- rpart(certified ~ grade + assignment, data = M1)
...
post(c.tree1_1, file = "tree1_1.ps", title = "MOOC") #This creates a pdf image of the tree
post(c.tree1_2, file = "tree1_2.ps", title = "MOOC") #This creates a pdf image of the tree

# There's no difference between 1 and 1_1
