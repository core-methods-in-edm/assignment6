...
post(c.tree1, file = "tree1.ps", title = "MOOC") #We get a PDF this way
...
#Data
```{r}
# Download file from here https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/26147 
#Upload 
