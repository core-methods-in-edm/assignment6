...
accuracy1 <- (table1[1,1] + table1[2,2]) / 10000
table2 <- table(M2$certified, M2$predict2)
accuracy2 <- (table2[1,1] + table2[2,2]) / 10000

accuracy1
accuracy2
```
The pruned tree has a lower error rate (53.63% accuracy) than the original tress (21.86% accuracy)