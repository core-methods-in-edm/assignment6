...
printcp(c.tree2)
```
It seems that tree1 has a lower cross validation error, since the "xerror" is smaller with three splits. And the CP (Cost Complexity) is smaller with three splits. Therefore, we think tree1 is a better model compared with tree2.