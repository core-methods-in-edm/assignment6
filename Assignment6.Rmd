...
c.tree1 <- rpart(certified ~ forum.posts + grade + assignment, control = rpart.control(minsplit = 10 ,cp=0.001), method ="class", data = M1)
...
```{r}
c.tree2 <- prune(c.tree1, cp = 0.004 )#Set cp to the level at which you want the tree to end
...
#They have the same rate of accurancy of 21.7%
```
